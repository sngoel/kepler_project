...
(A) .Rmd Line number(s) for an example of general purpose data wrangling: 54 - 216


(B) .Rmd Line number(s) for a spread & gather (or equivalent): 721


(C) .Rmd Line number(s) for use of regular expressions: 64 - 72, 149 - 154


(D) .Rmd Line number(s) for use of user-defined functions: 36 - 49, 848 - 864


(E) .Rmd Line number(s) for use of loops and/or control flow: 811 - 818
...
(A) .Rmd Line number(s) for visualization with layered data from distinct data structures--e.g., a `geom` that plots data from a secondary data frame: 253 - 262, 380 - 389, 506 - 515


(B) .Rmd Line number(s) for visualization displaying many--3 or more--variables (A, B, C, & D must be four **different** plots): 742 - 765, 768 - 792


(C) .Rmd Line number(s) for a third visualization: 264 - 318, 335 - 345


(D) .Rmd Line number(s) for a third visualization: 665 - 692
...
(A) .Rmd Line number(s) for statistical modeling/supervised learning:  329 - 351, 797 - 820


(B) .Rmd Line number(s) for unsupervised learning: 354 - 372, 826 - 843


(C) .Rmd Line number(s) for user-defined simulation(s): 846 - 899


(D) .Rmd Line number(s) for analysis of text data: 226 - 244
